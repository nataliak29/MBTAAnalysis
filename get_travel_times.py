...
def get_travel_times(main_from_date,main_to_date,from_time,to_time,from_stop,to_stop):
    ...
    numberOfDays = int((datetime.strptime(main_to_date, "%d.%m.%Y") - datetime.strptime(main_from_date, "%d.%m.%Y")).days)
